...
OWNER_ID = environ.get('OWNER_ID', '6914788581')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://useless:useless@superman.c90zq.mongodb.net/?retryWrites=true&w=majority&appName=Superman")
DATABASE_NAME = environ.get('DATABASE_NAME', "useless")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002245108673')) #Log channel id ( make sure bot is admin )
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Dev_Autofilterbot")
BOT_NAME = environ.get("BOT_NAME", "Auto Filter Bot")
BOT_ID = environ.get("BOT_ID", "7805202977")
